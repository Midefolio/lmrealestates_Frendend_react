   ...
   <div className="my-col-10 off-2 xs-container xs-down-20">
    <div className="my-col-10 down-5 xs-12 xs-down-2">
      <div className="px20">
       ...
       {summary &&    <Fade> <div className="my-mother down-6 xs-down-10">
      ...
      <div className="my-mother down-5 xs-down-10 hidden-l">
        <div className="my-col-4 xs-12 pd-10 rad-10 xs-my-b-shadow">
          <div className="xs-px13">Your Balance:</div>
        ...
        <div className="my-col-4 xs-12 xs-down-3 pd-10 rad-10 xs-my-b-shadow">
        <div className="xs-10 my-col-10">
            <div className="xs-px13">Pending Withdrawals:</div>
        ...
        <div className="my-col-4 xs-12 xs-down-3 pd-10 rad-10 xs-my-b-shadow">
          <div className="xs-10 my-col-10">
            <div className="xs-px13">Your Transactions:</div>
            <div className="xs-px13 xs-down- bold ">{formatNumber(currentUser?.balance)}</div>
            {/* <div className="my-mother down-2 c-pointer hidden-xs"><span className="pd-10 bg-faded color-code-1 px13">top up <i className="fas fa-arrow-down"></i></span></div> */}
          </div>
      ...
      <div className="my-col-12 xs-12 down-2 entered xs-down-3">
        <div className="xs-6 hidden-ls">
          <span className="my-btn-sm bg-color-code-1 xs-px10 px13 white" onClick={()=>{history.push('/dashboard/properties')}}>Buy / Rent Properties</span>
        </div>
        <div className="xs-6 hidden-ls">
        <span className="my-btn-sm bg-color-code-1 px13 xs-px10 white" onClick={()=>{history.push('/dashboard/post')}}>Sell / Rent Properties</span>
        </div>
        <span className="anchors bg-color-code-1 px13 white hidden-xs" onClick={()=>{history.push('/dashboard/properties')}}>Buy / Rent Properties</span>
        <span className="anchors bg-color-code-1 px13 white mg-10 hidden-xs" onClick={()=>{history.push('/dashboard/post')}}>Sell / Rent Out Properties</span>
      </div>
    </div>
